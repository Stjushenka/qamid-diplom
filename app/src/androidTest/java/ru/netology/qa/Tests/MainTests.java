...
public class MainTests {
    ...
    public void Authorization() throws InterruptedException {
        ...
        sleep(1000);
        AuthorizationPage.clickButton(AuthorizationPage.getAuthorizationElementsButton());
    }

    @AfterClass
    public static void Logout() {
        sleep(2000);
        AuthorizationPage.clickButtonExit(AuthorizationPage.getAuthorizationElementsButtonExit());
        sleep(2000);
